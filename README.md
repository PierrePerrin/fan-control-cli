...
```bash
# Tap and install
brew install --HEAD PierrePerrin/fan-control-cli/fan-control-cli

# Or tap first:
brew tap PierrePerrin/fan-control-cli
...
git clone https://github.com/PierrePerrin/fan-control-cli.git
cd fan-control-cli
